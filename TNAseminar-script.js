...
components.`,
    ...
    },
    {
        ...
        start: "1630",
        duration: 90,
        title: "共形場理論の数学的定式化について",
        speaker: "Yuto Moriwaki 森脇 湧登",
        affil: "RIKEN 理化学研究所",
        abstract: `場の量子論には超関数を用いた定式化である Wightman axioms や、確率測度を用いたGlimm-Jaffe axioms、ホモロジー代数を用いた因子化代数など、様々な定式化が存在する。本講演では共形対称性を持つ場の量子論の頂点作用素代数を用いた定式化と、ほかの様々な定式化との間の関係性を議論する。頂点作用素代数を用いたアプローチの重要性は場の量子論を表現論を用いて明示的に構成できることであり、これにより物理において場の量子論や弦理論の研究を通じて得られたミラー対称性などの様々な予想を定式化し検証できる枠組みが得られる。`,
        lang: "jp",
        access: { id: "878 3812 5302", psw: "272717" },
        // record: {
        //     slides: "TNA/2025/Yurikusa-Finite_Tame_Jacobian_Algebras.pdf",
        // },
    },
